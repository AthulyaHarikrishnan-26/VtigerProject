...
public class GenericUtilities {
	...
	// or else i can give return options
	...
	// ASCII values ofletters on  keyboard are stored in int format
	...
	public String getAlertMessage(WebDriver driver) {
		return driver.switchTo().alert().getText();//instead of this i can store in a variable and also return

	}

	public void switchConrolToNewTab(WebDriver driver) {
	...
	public String captureScreenshot(WebDriver driver,String path) {
		...
		try {
			...
			dst = new File(path);
			//File dst = new File("C:\\AUTOMATION TESTING\\M3Vtiger\\src\\test\\resources\\defectimages\\Defect_Vtiger_"+ currentDate() + ".jpg");
